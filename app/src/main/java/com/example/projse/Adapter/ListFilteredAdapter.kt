...
class ListFilteredAdapter(val items:MutableList<ItemsModel>):
RecyclerView.Adapter<ListFilteredAdapter.Viewholder>(){
    class Viewholder (val binding: ViewholderPopularBinding)
        :RecyclerView.ViewHolder(binding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListFilteredAdapter.Viewholder {
